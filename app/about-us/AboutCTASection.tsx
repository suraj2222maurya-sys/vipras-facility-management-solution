...
>
     <div
  aria-hidden="true"
  className="absolute left-[-120px] top-[-90px] h-80 w-80 rounded-full bg-[#d6b06a]/30 blur-3xl"
/>
   <div
  aria-hidden="true"
  className="absolute right-[-130px] bottom-[-100px] h-96 w-96 rounded-full bg-[#eadfca]/80 blur-3xl"
/>
        <div
  aria-hidden="true"
...
/>
  ...
  className="mx-auto mt-4 max-w-4xl text-3xl font-black leading-tight text-[#2f281f] sm:text-4xl lg:text-5xl"
>
  ...
  Partner with Vipras Facility Management Solutions for trusted
  ...
  Nadu and Pan India.
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              href="https://wa.me/919710946484?text=Hello%20Vipras%20Facility%20Management%20Solutions%2C%20I%20would%20like%20to%20get%20a%20free%20quote%20for%20facility%20management%20services."
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Contact Vipras Facility Management Solutions on WhatsApp for a facility management quote"
