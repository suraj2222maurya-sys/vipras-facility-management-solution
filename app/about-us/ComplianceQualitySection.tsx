...
export default function ComplianceQualitySection() {
  return (
    <section className="relative overflow-hidden bg-[#fff8ec] px-5 py-14 sm:px-8 lg:px-12">
      <div className="absolute left-[-110px] top-[-80px] h-72 w-72 rounded-full bg-[#d6b06a]/25 blur-3xl" />
      <div className="absolute right-[-120px] bottom-[-90px] h-80 w-80 rounded-full bg-[#eadfca]/80 blur-3xl" />
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 text-base font-medium leading-8 text-[#6f6254]">
              Vipras Facility Management Solution follows a quality-focused
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {qualityPoints.map((point) => (
              ...
              >
                <div className="mb-4 h-1 w-12 rounded-full bg-[#d6b06a] transition duration-500 group-hover:w-20" />
