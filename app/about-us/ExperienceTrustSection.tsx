...
export default function ExperienceTrustSection() {
  return (
    <section className="relative overflow-hidden bg-[#17130d] px-5 py-16 sm:px-8 lg:px-12">
      <div className="absolute left-[-140px] top-[-120px] h-96 w-96 animate-pulse rounded-full bg-[#b98a3c]/30 blur-3xl" />
      <div className="absolute right-[-150px] bottom-[-120px] h-[420px] w-[420px] animate-pulse rounded-full bg-[#f3d28b]/20 blur-3xl" />
      <div className="absolute left-1/2 top-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#eadfca]/10 blur-3xl" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,#d6b06a_1px,transparent_0)] bg-[length:34px_34px] opacity-10" />
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {stats.map((stat) => (
              ...
              >
                <div className="mb-5 h-1 w-14 rounded-full bg-[#d6b06a] transition duration-500 group-hover:w-24 group-hover:bg-[#f3d28b]" />
