...
export default function MissionVisionSection() {
  ...
  className="relative overflow-hidden bg-[#121812] px-5 py-16 sm:px-8 lg:px-12"
>
      <div
  aria-hidden="true"
  className="absolute left-[-120px] top-[-80px] h-80 w-80 animate-pulse rounded-full bg-[#d6b06a]/30 blur-3xl"
/>
     <div
  aria-hidden="true"
  className="absolute right-[-140px] bottom-[-90px] h-96 w-96 animate-pulse rounded-full bg-[#f3d28b]/20 blur-3xl"
/>
<div
  aria-hidden="true"
  className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,#d6b06a_1px,transparent_0)] bg-[length:32px_32px] opacity-10"
/>
...
>
  ...
  Vipras Facility Management Solutions works with a clear purpose: to
...
>
  {item.title}
        ...
        <div
  aria-label="Core values of Vipras Facility Management Solutions"
