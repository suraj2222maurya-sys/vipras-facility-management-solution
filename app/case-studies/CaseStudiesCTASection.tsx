...
const points = [
  "Share your site type and facility challenge",
  "Get a practical service plan from Vipras",
  "Start with one service or complete IFM support",
];
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_0.75fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight text-white sm:text-4xl">
                Want a facility management plan for your site?
              </h2>

              <p className="mt-5 max-w-3xl text-base leading-8 text-[#F3E9D2]">
                Tell us your location, service requirement and manpower need.
                Vipras Facility Management Solution will guide you with a
                practical support plan for your business environment.
              </p>
