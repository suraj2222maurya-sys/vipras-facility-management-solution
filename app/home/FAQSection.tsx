...
const faqs = [
  {
    id: "facility-management-services-chennai",
  ...
  {
    id: "facility-management-services-tamil-nadu-pan-india",
  ...
  {
    id: "facility-management-for-factories-it-parks-hospitals-apartments",
  ...
  {
    id: "trained-supervised-facility-management-staff",
  ...
  {
    id: "request-facility-management-proposal",
...
export default function FAQSection() {
  ...
  <>
    ...
    <section
  id="facility-management-faqs"
  aria-labelledby="facility-management-faq-heading"
  className="relative overflow-hidden bg-[#fffaf2] px-5 py-16 sm:px-8 lg:px-12"
>
       <div
  aria-hidden="true"
  className="absolute left-[-80px] top-8 h-80 w-80 animate-pulse rounded-full bg-[#b98a3c]/35 blur-3xl"
/>

<div
  aria-hidden="true"
  className="absolute right-[-90px] bottom-8 h-96 w-96 animate-pulse rounded-full bg-[#d6b06a]/40 blur-3xl"
/>

<div
  aria-hidden="true"
  className="absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#eadfca]/70 blur-3xl"
/>

<div
  aria-hidden="true"
  className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,#d6b06a_1px,transparent_0)] bg-[length:28px_28px] opacity-20"
/>
    <div className="relative mx-auto max-w-5xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2
  id="facility-management-faq-heading"
  className="mt-3 text-2xl font-black leading-tight text-[#2f281f] sm:text-3xl lg:text-4xl"
>
...
>
                  ...
                  <span
  aria-hidden="true"
  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#f8f1e7] text-xl font-black text-[#b98a3c]"
>
  {isOpen ? "−" : "+"}
</span>
                </button>
