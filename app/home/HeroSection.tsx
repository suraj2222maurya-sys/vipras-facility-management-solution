    ...
    <section className="relative w-full overflow-hidden bg-[#0f1713]">
        ...
        <div className="relative z-10 flex min-h-[680px] w-full items-start px-5 pb-20 pt-12 sm:min-h-[720px] sm:items-center sm:px-8 sm:py-20 lg:min-h-[calc(100vh-76px)] lg:px-12">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 hidden max-w-2xl bg-gradient-to-r from-[#a8ff1a] via-[#ff8a24] to-[#35f0ff] bg-clip-text text-base font-bold leading-8 text-transparent drop-shadow-[0_3px_8px_rgba(0,0,0,0.95)] sm:block sm:text-lg">
              ...
              Tamil Nadu maintain safe, clean and well-managed facilities
              through integrated facility management services, security
              services, housekeeping services, manpower services, Mechanical,
              Electrical and Plumbing maintenance, fire safety support and
              reliable day-to-day operations with Pan India service capability.
            </p>
      ...
      <div className="px-5 pb-8 sm:hidden">
        <p className="bg-gradient-to-r from-[#a8ff1a] via-[#ff8a24] to-[#35f0ff] bg-clip-text text-sm font-bold leading-7 text-transparent drop-shadow-[0_3px_8px_rgba(0,0,0,0.95)]">
          ...
          Nadu maintain safe, clean and well-managed facilities through
