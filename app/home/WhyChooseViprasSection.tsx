export default function WhyChooseViprasSection() {
  return (
    <section
  id="why-choose-vipras-facility-management"
  aria-labelledby="why-choose-vipras-heading"
  className="relative overflow-hidden bg-[#10130f] px-5 py-20 sm:px-8 lg:px-12"
>
     <div
  aria-hidden="true"
...
<div
  aria-hidden="true"
  className="absolute inset-0 bg-gradient-to-b from-black/5 via-black/25 to-black/85 sm:bg-gradient-to-r sm:from-black/45 sm:via-black/20 sm:to-transparent"
/>
...
>
  ...
  <article
  aria-labelledby="trained-workforce-heading"
  className="rounded-2xl border border-white/15 bg-white/10 p-4"
>
    <h3
  id="trained-workforce-heading"
...
>
  ...
  <article
  aria-labelledby="active-site-supervision-heading"
  className="rounded-2xl border border-white/15 bg-white/10 p-4"
>
  <h3
  id="active-site-supervision-heading"
  className="text-sm font-black text-white"
>
  ...
  <article
  aria-labelledby="safety-focused-operations-heading"
  className="rounded-2xl border border-white/15 bg-white/10 p-4"
>
  <h3
  id="safety-focused-operations-heading"
  className="text-sm font-black text-white"
>
  ...
  <article
  aria-labelledby="chennai-pan-india-support-heading"
  className="rounded-2xl border border-white/15 bg-white/10 p-4"
>
  <h3
  id="chennai-pan-india-support-heading"
  className="text-sm font-black text-white"
>
  Chennai & Pan India Support
</h3>
  <p className="mt-2 text-sm leading-6 text-white/75">
