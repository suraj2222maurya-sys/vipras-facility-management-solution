  ...
  return (
    <section className="relative isolate overflow-hidden bg-slate-950">
      <div
        ...
        style={{
          backgroundImage: "url('/vipras-blog-hero-bg.jpg.jpg')",
        }}
      />
      ...
      <div className="mx-auto flex min-h-[500px] max-w-7xl items-center px-4 py-16 sm:px-6 lg:min-h-[540px] lg:px-8">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link
              href="/contact-us"
              className="inline-flex items-center justify-center rounded-full bg-[#c89b3c] px-7 py-3.5 text-sm font-extrabold text-slate-950 shadow-lg shadow-black/25 transition duration-300 hover:-translate-y-0.5 hover:bg-[#e1b85a] focus:outline-none focus:ring-2 focus:ring-[#f5d27a] focus:ring-offset-2 focus:ring-offset-slate-950"
            >
              Get Free Quote
